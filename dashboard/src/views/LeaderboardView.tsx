  ...
  return (
    <div className="space-y-6 text-[#A9B1D6]">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-3xl font-bold text-[#A9B1D6]">Hero Leaderboard</h2>
          <p className="text-sm text-[#A9B1D6]/70">Ranked by level and experience</p>
        </div>
      </div>
          ...
          <tbody>
            {sorted.map((row) => (
              ...
              >
                ...
                <td className="p-4 text-[#A9B1D6]/85">{row.mp.party || 'Independent'}</td>
